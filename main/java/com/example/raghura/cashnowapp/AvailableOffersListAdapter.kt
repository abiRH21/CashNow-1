...
//                                }
            ...
            quoteRef
                    .orderBy(Offer.LAST_TOUCHED_KEY, Query.Direction.ASCENDING).whereEqualTo("accepted","F").whereEqualTo("desiredCurrency", desiredCurrency)
...
//                                }
            ...
            quoteRef
                    .orderBy(Offer.LAST_TOUCHED_KEY, Query.Direction.ASCENDING).whereEqualTo("accepted","F").whereEqualTo("userCurrency", userCurrency)
